...
export const teamData = [
  { name: 'Amarnath Chaubey', title: 'CEO & founder', image: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200' },
  { name: 'Aditya Chaubey', title: 'Ads manager', image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200' },
  { name: 'Prabhawati Chaubey', title: 'Vice president', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&auto=format&fit=crop' },
  { name: 'kriti Chaubey', title: 'Marketing & sales', image: 'https://randomuser.me/api/portraits/women/10.jpg' },
  { name: 'Aditi Chaubey', title: 'Content marketer', image: 'https://randomuser.me/api/portraits/women/11.jpg' },
